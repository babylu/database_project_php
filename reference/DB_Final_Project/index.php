                ...
                <div class='row'>    
                    <div class="span5">  
                        <form name="logon" action="index.php" method="POST" >
                            <fieldset>
                                <legend>LOGIN<i class='icon-user-3'></i></legend>
                    ...
                    <div class='span6'>
                        <div class="tile double live" data-role="live-tile" data-effect="slideLeftRight"  style="height:250px;width:500px">
                            ...
                            <div class="tile-status bg-lightBlue opacity">
