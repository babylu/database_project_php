                    ...
                    <div class="span3">
                        <nav class="sidebar light">
                            <ul>
                                ...
                                <li class="stick"><a href="customer_main.php"><i class="icon-search"></i>Find Customer</a></li>
                                <li class="title">View</li>
                                <li class="stick bg-red"><a href="view_home_customer.php"><i class="icon-smiley"></i>Home Type</a></li>
                                <li class="stick bg-green active"><a href="view_business_customer.php"><i class="icon-briefcase-2"></i>Business Type</a></li>
